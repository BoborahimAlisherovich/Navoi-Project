...
from .views import home_view,blog_view,blog_single_post_view,page_about_us_view,page_contact_view,page_faq_view,page_agents_view,page_testimonials_view,page_service_box_view,page_partners_view,page_services_view,page_single_service_view,page_turt_view,page_portfolio_list_view,single_project_view
