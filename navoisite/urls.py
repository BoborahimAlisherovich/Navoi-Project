...
from .views import home_view,Blogview,SinglePost,page_about_us_view,page_faq_view,page_agents_view,page_testimonials_view,page_service_box_view,page_partners_view,Services,single_service,page_turt_view,page_portfolio_list_view,single_project_view,ContactView
...
urlpatterns = [
    ...
    path('page-single-service/<int:pk>/',single_service.as_view(), name="single-service-page"), #page_turt_view
